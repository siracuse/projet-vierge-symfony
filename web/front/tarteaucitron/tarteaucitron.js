...
var tarteaucitron = {
          ...
          if(tarteaucitronCustomText !== ''){
            ...
            tarteaucitron.addScript(pathToServices, '', function () {
                ...
                for (i = 0; i < cat.length; i += 1) {
                    ...
                    html += '               <button type="button" onclick="tarteaucitron.userInterface.toggle(\'tarteaucitronDetails' + cat[i] + '\', \'tarteaucitronInfoBox\');return false"> ' + tarteaucitron.lang[cat[i]].title + ' <span>( en savoir plus )</span></button>';
                    html += '            </div>';
                ...
                html += '       </div>';
                //#TARTE TROISIEME PARTIE
                html += '       <div class="tarteaucitronThirdPart">';
                html += '           <button id="tarteaucitronClosePanelNewButton" class="tartaucitronThirdPartButton" onclick="tarteaucitron.userInterface.closePanel();">';
                html += '           ' + tarteaucitron.lang.close;
                html += '           </button>';
                html += '       </div>';
                //FIN TROISIEME
                ...
                if (tarteaucitron.parameters.highPrivacy && !tarteaucitron.parameters.AcceptAllCta) {
                    ...
                    html += '<div class="tarteaucitronAlertText col-12 col-md-8">';
                    html += '   <p class="tarteaucitronAlertTitleText">GESTION DES COOKIES</p>'; //#TARTE rajout d'un title
                    html += '   <span id="tarteaucitronDisclaimerAlert">'; //#TARTE rajout de 2 div pour width 70% et 30% .AlertText et .AlertButton
                    ...
                    //html += '   <span class="tarteaucitronAlertBigBtnWrapper">';
                    html += ' <div class="tarteaucitronAlertButton col-12 col-md-2">';
                ...
                if (tarteaucitron.parameters.adblocker === true) {
                    setTimeout(function () {
                        if (tarteaucitronNoAdBlocker === false) {
                            html = '<div id="tarteaucitronAlertBig" class="tarteaucitronAlertBig' + orientation + '"  role="alert" aria-live="polite">';
    ...
    "userInterface": {
        ...
        "openPanel": function () {
            ...
            document.getElementById('tarteaucitronClosePanelNewButton').focus();
        ...
        "openAlert": function () {
            ...
            // tarteaucitron.userInterface.css(c + 'AlertBig',   'display', 'flex'); //#TARTE modif display flex
